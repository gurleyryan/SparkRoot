          ...
          <div className="flex items-center h-16 gap-4 md:gap-8">
            ...
            <div className="flex items-center gap-3 flex-1 min-w-0 overflow-hidden">
              <Link href="/" className="flex items-center group min-w-0" aria-label="Go to home page">
                <Image src="/logo.png" alt="SparkRoot Logo" className="w-12 h-12 md:w-12 md:h-12 sm:w-7 sm:h-7 xs:w-6 xs:h-6 group-hover:scale-105 transition-transform flex-shrink-0" width={23} height={32} />
                <span

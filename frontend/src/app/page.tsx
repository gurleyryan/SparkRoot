...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <div className="sleeve-morphism rounded-xl p-8 max-w-7xl mx-auto mb-12 border shadow-xl text-center" style={{ backgroundColor: "rgba(var(--color-mtg-black-rgb, 21,11,0),0.72)" }}>

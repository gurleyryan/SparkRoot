...
export default function HomePage() {
  ...
  return (
    <div className="container mx-auto min-h-screen">
      {/* Hero Section - always rendered, never swapped */}
      <div className="sleeve-morphism rounded-xl p-8 mx-auto mb-12 border shadow-xl text-center" style={{ backgroundColor: "rgba(var(--color-mtg-black-rgb, 21,11,0),0.72)" }}>
        <Image src="/logo.png" alt="SparkRoot Logo" className="mx-auto mb-4" width={350} height={500} style={{ width: 'auto', height: 'auto' }} />
      ...
      {/* Main Content - only this swaps, hero/nav/background remain stable */}
      <main>
        {isLoading ? (

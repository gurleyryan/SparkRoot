  ...
  return (
    <div className="min-h-screen bg-mtg-black">
      ...
      <div className="container mx-auto px-4 py-8">
        {/* Hero Section */}
        <div className="bg-mtg-black sleeve-morphism rounded-xl p-8 mb-12 border border-mtg-blue shadow-xl text-center" style={{backgroundColor: "rgba(var(--color-mtg-black-rgb, 21,11,0),0.72)"}}>
        ...
        {!isAuthenticated ? (
          <div className="text-center py-12">
            <div className="bg-mtg-black sleeve-morphism rounded-xl p-8 max-w-2xl mx-auto border border-gray-700" style={{backgroundColor: "rgba(var(--color-mtg-black-rgb, 21,11,0),0.72)"}}>
